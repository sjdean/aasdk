...
namespace aasdk::channel::wifiprojection {
  ...
  public:
    typedef std::shared_ptr<IWifiProjectionServiceEventHandler> Pointer;

    IWifiProjectionServiceEventHandler() = default;

    virtual ~IWifiProjectionServiceEventHandler() = default;

    virtual void
    onWifiCredentialsRequest(const aap_protobuf::service::wifiprojection::message::WifiCredentialsRequest &request) = 0;
