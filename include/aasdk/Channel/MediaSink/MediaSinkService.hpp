...
#include "aasdk/Channel/Channel.hpp"
#include "IMediaSinkService.hpp"

namespace aasdk::channel::mediasink {

  class MediaSinkService
      : public IMediaSinkService, public Channel, public std::enable_shared_from_this<MediaSinkService> {
  public:
    MediaSinkService(boost::asio::io_service::strand &strand, messenger::IMessenger::Pointer messenger,
  ...
  private:
    ...
    void
    handleStartIndication(const common::DataConstBuffer &payload, IMediaSinkServiceEventHandler::Pointer eventHandler);

    void
    handleStopIndication(const common::DataConstBuffer &payload, IMediaSinkServiceEventHandler::Pointer eventHandler);
