    ...
    namespace ut {
      ...
      protected:
        ConnectedAccessoriesEnumeratorUnitTest()
            : queryChain_(&queryChainMock_, [](auto *) {}), deviceListHandle_(&deviceList_, [](auto *) {}),
          ...
          promise_->then(std::bind(&ConnectedAccessoriesEnumeratorPromiseHandlerMock::onResolve, &promiseHandlerMock_,
                                   std::placeholders::_1),
                         std::bind(&ConnectedAccessoriesEnumeratorPromiseHandlerMock::onReject, &promiseHandlerMock_,
                                   std::placeholders::_1));
        }
      ...
      BOOST_FIXTURE_TEST_CASE(ConnectedAccessoriesEnumerator_FirstDeviceIsAOAPCapables,
                              ConnectedAccessoriesEnumeratorUnitTest)
      {
        ...
        auto connectedAccessoriesEnumerator(
            std::make_shared<ConnectedAccessoriesEnumerator>(usbWrapperMock_, ioService_, queryChainFactoryMock_));
        ...
        EXPECT_CALL(usbWrapperMock_, open(*deviceList_.begin(), _)).WillOnce(
            DoAll(SetArgReferee<1>(deviceHandle_), Return(0)));
      ...
      BOOST_FIXTURE_TEST_CASE(ConnectedAccessoriesEnumerator_SecondDeviceIsAOAPCapable,
                              ConnectedAccessoriesEnumeratorUnitTest)
      {
        deviceList_.push_back(reinterpret_cast<libusb_device *>(1));
        ...
        EXPECT_CALL(usbWrapperMock_, open(*(++deviceList_.begin()), _)).WillOnce(
            DoAll(SetArgReferee<1>(deviceHandle2), Return(0)));
      ...
      BOOST_FIXTURE_TEST_CASE(ConnectedAccessoriesEnumerator_NoAOAPCapableDevice,
                              ConnectedAccessoriesEnumeratorUnitTest)
      {
      ...
      BOOST_FIXTURE_TEST_CASE(ConnectedAccessoriesEnumerator_GetDeviceListFailed,
                              ConnectedAccessoriesEnumeratorUnitTest)
      {
